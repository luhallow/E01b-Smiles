...
arcade.draw_ellipse_filled(face_x + 25, face_y + 50, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x - 25, face_y + 50, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x + 28, face_y + 63, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x - 22, face_y + 63, 3, open_color.gray_2)
